$(document).ready(function(){
 ...
 if(w>768){
      ...
      $(".vertical-list").find(".card").css("width",(w-250)-15+"px");
      if(w>992){
          $(".horizontal-list").find(".card").css("width",((w-250)/5)-10+"px");
           
          $(".popsize").css("width",((w-250)/5)-10+"px");
          $(".card > a > img").css("width",((w-250)/5)-10+"px");
          $(".card > a > img").css("height",((w-250)/5)-10+"px");
      }else if(w<992){
          $(".horizontal-list").find(".card").css("width",((w-250)/4)-10+"px");
          $(".popsize").css("width",((w-250)/4)-10+"px");
      ...
      $(".horizontal-list").find(".card").css("width",w-10+"px");
      $(".vertical-list").find(".card").css("width",(w)-15+"px");
      
      $(".popsize").css("width",(w/3)+"px");
  ...
  $(window).resize(function(){
      ...
      $(".body").css("width",(w-250)+"px");
      $(".carousel_container").css("height",(w-300)/3+"px");
      $(".vertical-list").find(".card").css("width",(w-250)-20+"px");
      if(w>992){
          $(".horizontal-list").find(".card").css("width",((w-250)/5)-10+"px");
          $(".popsize").css("width",((w-250)/5)-10+"px");
          $(".card > a > img").css("width",((w-250)/5)-10+"px");
      ...
      $(".body").css("width",(w+0)+"px");
      $(".carousel_container").css("height",(w-100)/2+"px"); 
      $(".horizontal-list").find(".card").css("width","100%");
      $(".vertical-list").find(".card").css("width",(w)-15+"px");
      $(".popsize").css("width",(w/3)+"px");
      $(".card > a > img").css("width",(w/3)+"px");
      $(".card > a > img").css("height",(w/3)+"px");
